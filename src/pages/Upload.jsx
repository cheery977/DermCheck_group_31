...
import { Upload as UploadIcon, Camera, X, ChevronRight, ChevronLeft, Loader2 } from 'lucide-react'
      ...
      <div className="flex justify-between">
        ...
        {step < STEPS.length - 1 ? (
          ...
          <button
            ...
            disabled={submitting}
          >
            {submitting ? <><Loader2 size={16} className="animate-spin" /> Analysing…</> : 'Submit for Analysis'}
          </button>
        )}
      </div>
    </div>
